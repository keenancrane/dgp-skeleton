...
namespace DDG
{
   class Mesh
   {
      ...
      protected:
         ...
         void buildDifferentialOperators( void );
         // builds differential operators on 0-, 1-, and 2-forms (listed below)

         SparseMatrix<Real> star0, star1, star2;
         // Hodge star on primal 0-, 1-, and 2-forms

         SparseMatrix<Real> d0, d1;
         // exterior derivative on 0- and 1-forms
         
         SparseMatrix<Real> delta1, delta2;
         // codifferential on primal 1- and 2-forms
         
         SparseMatrix<Real> Delta0, Delta1;
         // Laplacian on 0- and 1-forms
   };
}
